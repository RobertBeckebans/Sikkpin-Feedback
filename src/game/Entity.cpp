...
/*
================
idEntity::UpdateIncendiaryBurn
================
*/
void idEntity::UpdateIncendiaryBurn( void ) {
	idPlayer* player = gameLocal.GetLocalPlayer();
	if ( player->modifiers.weapon_incendiary && gameLocal.time < burnTime && health > 0 ) {
		if ( gameLocal.time >= burnIntervalTime ) {
			burnPower = burnPower > 10 ? 10 : burnPower;
			idEntityFx::StartFx( "fx/incendiary_burn.fx", &GetPhysics()->GetAbsBounds().GetCenter(), &GetPhysics()->GetAxis(), NULL, false );
			Damage( player, player, idVec3( 0, 0, 0 ), "damage_incendiary", burnPower, INVALID_JOINT );
			burnIntervalTime = gameLocal.time + SEC2MS( g_burnIntervalTime.GetFloat() );
		}
	} else { 
		burnPower = 1;
	}
...
/*
================
idEntity::GetRandomModifier
================
*/
const char * idEntity::GetRandomModifier( void ) const {
	int mod = gameLocal.random.RandomInt( 12 );
	switch ( mod ) {
		case 0: return "modifier_player_speed";
		case 1: return "modifier_player_doublejump";
		case 2: return "modifier_player_aircontrol";
		case 3: return "modifier_weapon_projectilespeed";
		case 4: return "modifier_weapon_projectiledoubler";
		case 5: return "modifier_weapon_incendiary";
		case 6: return "modifier_energy_rechargerate";
		case 7: return "modifier_energy_conservation";
		case 8: return "modifier_energy_pickupdoubler";
		case 9: return "modifier_misc_scoredoubler";
		case 10: return "modifier_misc_poweruptimedoubler";
		case 11: return "modifier_misc_combotimedoubler";
	}
	return "";
}// <--- sikk - Modifier System