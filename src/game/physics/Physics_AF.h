...
// ---> sikk - Liquid Physics
	// returns the depth of the object in the water, 0.0f if out of water
...
// ---> sikk - Liquid Physics
							// buoyancy stuff
	void					SetLiquidDensity( float density ) { liquidDensity = density; }
	...
	bool					GetFixedDensityBuoyancy() const { return fixedDensityBuoyancy; }
// <--- sikk - Liquid Physics
