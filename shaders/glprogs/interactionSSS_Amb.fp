###==============================================================================
#	Feedback Interaction Sub-Surface Scattering Ambient Fragment Program 
#
...
TEMP	diffuse, specular, gloss, rough, color, ambient, atten, ssao, sss; 
TEMP	R1, R2, R3;
TEMP	S1, S2, S3;
TEMP 	C1, C2, C3;
...
DP3 	ambient.w, ambient, lumVec;
MUL 	ambient.w, ambient.w, ambient.w;
LRP_SAT sss.xyz, ambient.w, refColor, sssColor;
DP3 	sss.w, diffuse, lumVec;
MUL 	sss.xyz, sss, sss.w;

MAD_SAT sss.w, ambient.w, -ambient.w, ambient.w;
MUL 	sss.w, sss.w, sssParm.x;
POW 	sss.w, sss.w, sssParm.y;
MUL 	sss.w, sss.w, sssParm.z;
MAD 	ambient.xyz, sss, sss.w, ambient;
