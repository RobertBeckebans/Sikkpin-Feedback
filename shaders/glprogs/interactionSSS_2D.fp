###==============================================================================
#	Feedback Interaction Sub-Surface Scattering 2D Fragment Program 
#
...
PARAM	sssColor	= program.local[0];	# sub-surface scattering color
PARAM	refColor	= program.local[1];	# reflected color (usually inverted sss color)
PARAM	lambertParm	= program.local[2];	# NdotL scale, bias, power
PARAM	sssParm		= program.local[3];	# sss scale, power, final scale
...
TEMP	light, sss, atten, lightFall, lightProj;
...
MOV_SAT NdotL.y, NdotL.x;
MAD_SAT NdotL.z, NdotL.x, lambertParm.x, lambertParm.y;
POW_SAT NdotL.y, NdotL.y, lambertParm.z;
POW_SAT NdotL.z, NdotL.z, lambertParm.w;
LRP_SAT NdotL.w, NdotL.x, NdotL.z, NdotL.y;

LRP_SAT sss.xyz, NdotL.w, refColor, sssColor;
DP3 	sss.w, diffuse, lumVec;
MUL 	sss.xyz, sss, sss.w;

MAD_SAT sss.w, NdotL.z, -NdotL.z, NdotL.z;
MUL 	sss.w, sss.w, sssParm.x;
POW 	sss.w, sss.w, sssParm.y;
MUL 	sss.w, sss.w, sssParm.z;
MUL 	sss, sss, sss.w;
MUL 	light, lightColor, atten;
MUL 	sss, sss, light;
MAX 	sss, sss, 0.0;
