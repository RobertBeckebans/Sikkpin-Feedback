###==============================================================================
#	Feedback Interaction Cloth 2D Fragment Program 
#
...
PARAM	clothParm1	= program.local[0];	# scatter, diffuse
PARAM	clothParm2	= program.local[1];	# side light fuzz, fuzz sharpness, view fuzz, fuzz power
PARAM	clothParm3	= program.local[2];	# fuzz amount
...
TEMP	atten, fuzz, lightFall, lightProj;
...
ADD_SAT fuzz.x, const.x, -NdotV.x;
MUL_SAT fresnel.w, fuzz.x, VdotL.x;
...
# calculate fuzz scatter
MAD 	fuzz.x, fuzz.x, clothParm1.x, clothParm1.y;
POW_SAT fuzz.x, fuzz.x, clothParm1.z;
MUL 	fuzz.x, fuzz.x, clothParm1.w;

# calculate view fuzz
MAD 	fuzz.y, VdotL.x, clothParm2.x, clothParm2.y;
POW_SAT fuzz.y, fuzz.y, clothParm2.z;
MUL 	fuzz.y, fuzz.y, clothParm2.w;
MUL 	fuzz.x, fuzz.x, fuzz.y;

# final fuzz power and scale
POW_SAT fuzz.x, fuzz.x, clothParm3.x;
MUL 	fuzz.x, fuzz.x, clothParm3.y;

LRP 	diffuse, diffuse, 1.0, fuzz.x;

MUL 	specular, specular, 0.1;
...
# MUL 	specular, specular, fresnel;
# MOV 	oColor.xyz, fuzz.y;
