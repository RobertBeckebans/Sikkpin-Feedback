###==============================================================================
#	Feedback Interaction Cloth Ambient Fragment Program 
#
...
TEMP	diffuse, specular, gloss, rough, fuzz, color, ambient, atten; 
TEMP	R1, R2, R3;
TEMP	S1, S2, S3;
TEMP 	C1, C2, C3;
...
ADD_SAT reflectVec.w, 1.0, -reflectVec.w;
POW 	rough.z, reflectVec.w, 5.0.x;
MUL 	R1, gloss, rough.y;
LRP 	gloss, rough.z, gloss, R1;

# calculate fuzz scatter
MAD 	fuzz.x, reflectVec.w, clothParm1.x, clothParm1.y;
