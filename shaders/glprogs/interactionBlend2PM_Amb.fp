###==============================================================================
#	Feedback Interaction Stain Ambient Fragment Program 
#
...
PARAM 	heightScale = program.local[2];
PARAM 	heightBias 	= program.local[3];
...
TEX 	normalVec, normalTC.xyxy, texture[2], 2D;
TEX 	normalVec2, normalTC.xyxy, texture[7], 2D;
MOV 	R2.x, normalVec.w;
MOV 	R2.y, normalVec2.w;
MAD 	R2, R2, heightScale, -heightBias;
LRP		R2.w, blend.w, R2.x, R2.y;
...
TEX 	normalVec2, R1.xyxy, texture[7], 2D;
TEX		diffuse2, R2.xyxy, texture[8], 2D;
TEX		gloss2, R2.zwzw, texture[9], 2D;

# do normal/diffuse/spec blending
LRP 	normalVec.xyz, blend.w, normalVec, normalVec2;
LRP 	diffuse.xyz, blend.w, diffuse, diffuse2;
LRP 	gloss.xyz, blend.w, gloss, gloss2;
