...
// ---> sikk - Rail Charge
	qhandle_t				railChargeParticleModelDefHandle;
	qhandle_t				railChargeParticleLightDefHandle;
	renderEntity_t			railChargeParticleRenderEntity;
	renderLight_t			railChargeParticleRenderLight;
	int						railChargeParticleTime;
	int						railChargeTime;
	int						railCharge;
// <--- sikk - Rail Charge
