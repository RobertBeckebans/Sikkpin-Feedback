...
// ---> sikk - Liquid Physics
	inline const idEntity  *GetSelf() { return self; }
	void					SetWater( idPhysics_Liquid *e ) { water = e; }
	idPhysics_Liquid *		GetWater() { return water; }
	float					SetWaterLevelf();
	float					GetWaterLevelf() const { return (float)( water != NULL ); }
// <--- sikk - Liquid Physics
...
protected:
	...
	idPhysics_Liquid		*water;					// the water object the object is in, we use this to check density/viscosity	// sikk - Liquid Physics
