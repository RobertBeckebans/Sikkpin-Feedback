...
idCVar g_crosshair(					"g_crosshair",					"1",		CVAR_GAME | CVAR_NOCHEAT | CVAR_ARCHIVE | CVAR_INTEGER,	"crosshair style. 0 = off" );
idCVar g_crosshairScale(			"g_crosshairScale",				"1.0",		CVAR_GAME | CVAR_NOCHEAT | CVAR_ARCHIVE | CVAR_FLOAT,	"crosshair scale" );
idCVar g_crosshairAlpha(			"g_crosshairAlpha",				"1.0",		CVAR_GAME | CVAR_NOCHEAT | CVAR_ARCHIVE | CVAR_FLOAT,	"crosshair alpha" );
idCVar g_showHudTime(				"g_showHudTime",				"1",		CVAR_GAME | CVAR_NOCHEAT | CVAR_ARCHIVE | CVAR_BOOL,	"toggles time hud element" );
idCVar g_showHudSpeed(				"g_showHudSpeed",				"1",		CVAR_GAME | CVAR_NOCHEAT | CVAR_ARCHIVE | CVAR_BOOL,	"toggles speed hud element" );
idCVar g_showHudScore(				"g_showHudScore",				"1",		CVAR_GAME | CVAR_NOCHEAT | CVAR_ARCHIVE | CVAR_BOOL,	"toggles score hud element" );
// <--- sikk - Crosshair Cvars
...
// ---> sikk - Energy Give
idCVar g_healthpoolGiveTime(		"g_healthpoolGiveTime",			"0.333",	CVAR_GAME | CVAR_ARCHIVE | CVAR_FLOAT,		"how often to regenerate energy from kills" );
idCVar g_healthpoolGiveDelay(		"g_healthpoolGiveDelay",		"3",		CVAR_GAME | CVAR_ARCHIVE | CVAR_FLOAT,		"delay (in seconds) before energy starts to regenerate after taking damage" );
idCVar g_healthpoolGiveAmt(			"g_healthpoolGiveAmt",			"5",		CVAR_GAME | CVAR_ARCHIVE | CVAR_INTEGER,	"how much energy to regenerate per g_healthpoolGiveTime" );
idCVar g_healthGiveTime(			"g_healthGiveTime",				"1",		CVAR_GAME | CVAR_ARCHIVE | CVAR_FLOAT,		"how often to regenerate energy" );
idCVar g_healthGiveDelay(			"g_healthGiveDelay",			"5",		CVAR_GAME | CVAR_ARCHIVE | CVAR_FLOAT,		"delay (in seconds) before energy starts to regenerate after taking damage" );
idCVar g_healthGiveAmt(				"g_healthGiveAmt",				"1",		CVAR_GAME | CVAR_ARCHIVE | CVAR_INTEGER,	"how much energy to regenerate per g_healthRegenTime" );
idCVar g_healthGiveLimit(			"g_healthGiveLimit",			"50",		CVAR_GAME | CVAR_ARCHIVE | CVAR_INTEGER,	"total amount of energy that can be regenerated" );
idCVar g_healthTakeTime(			"g_healthTakeTime",				"5",		CVAR_GAME | CVAR_ARCHIVE | CVAR_FLOAT,		"how often to take health" );
idCVar g_healthTakeDelay(			"g_healthTakeDelay",			"10",		CVAR_GAME | CVAR_ARCHIVE | CVAR_FLOAT,		"delay (in seconds) before energy starts to degenerate" );
idCVar g_healthTakeAmt(				"g_healthTakeAmt",				"5",		CVAR_GAME | CVAR_ARCHIVE | CVAR_INTEGER,	"how much health to take" );
idCVar g_healthTakeLimit(			"g_healthTakeLimit",			"25",		CVAR_GAME | CVAR_ARCHIVE | CVAR_INTEGER,	"how low can health get taken" );

idCVar g_energySystem(				"g_energySystem",				"0",		CVAR_GAME | CVAR_ARCHIVE | CVAR_BOOL,		"select which health system to use" );
idCVar g_energyPct(					"g_energyPct",					"0.1",		CVAR_GAME | CVAR_ARCHIVE | CVAR_FLOAT,		"Percentage of energy given from kills" );

idCVar g_musicTime(					"g_musicTime",					"10",		CVAR_GAME | CVAR_ARCHIVE | CVAR_FLOAT,		"music timer (in sec). High tempo music start to fade after this many seconds" );
idCVar g_comboTime(					"g_comboTime",					"7.5",		CVAR_GAME | CVAR_ARCHIVE | CVAR_FLOAT,		"combo timer (in sec)" );
idCVar g_comboMultiplier(			"g_comboMultiplier",			"4.0",		CVAR_GAME | CVAR_ARCHIVE | CVAR_FLOAT,		"combo energy multiplier" );
// <--- sikk - Energy Give

// ---> sikk - Modifier System
idCVar g_modifierChance(			"g_modifierChance",				"0.25",		CVAR_GAME | CVAR_ARCHIVE | CVAR_FLOAT,		"chance that a monster will drop a modifier when killed" );
idCVar g_burnTime(					"g_burnTime",					"10",		CVAR_GAME | CVAR_ARCHIVE | CVAR_FLOAT,		"time span incendiary damage will last" );
idCVar g_burnIntervalTime(			"g_burnIntervalTime",			"1",		CVAR_GAME | CVAR_ARCHIVE | CVAR_FLOAT,		"time span between each incendiary damage pulse" );
// <--- sikk - Modifier System
