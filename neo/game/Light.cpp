...
// ---> sikk - Ambient Light Color
	args->GetVector( "ambColor_X_Neg", "0.25 0.25 0.25",		ambColor_X_Neg );
	args->GetVector( "ambColor_X_Pos", "0.25 0.25 0.25",		ambColor_X_Pos );
	args->GetVector( "ambColor_Y_Neg", "0.25 0.25 0.25",		ambColor_Y_Neg );
	args->GetVector( "ambColor_Y_Pos", "0.25 0.25 0.25",		ambColor_Y_Pos );
	args->GetVector( "ambColor_Z_Neg", "0.0625 0.0625 0.0625",	ambColor_Z_Neg );
	args->GetVector( "ambColor_Z_Pos", "1.0 1.0 1.0",			ambColor_Z_Pos );
	renderLight->shaderParms[ 10 ]	= ambColor_X_Neg[0];
	renderLight->shaderParms[ 11 ]	= ambColor_X_Neg[1];
	renderLight->shaderParms[ 12 ]	= ambColor_X_Neg[2];
	renderLight->shaderParms[ 13 ]	= ambColor_X_Pos[0];
	renderLight->shaderParms[ 14 ]	= ambColor_X_Pos[1];
	renderLight->shaderParms[ 15 ]	= ambColor_X_Pos[2];
	renderLight->shaderParms[ 16 ]	= ambColor_Y_Neg[0];
	renderLight->shaderParms[ 17 ]	= ambColor_Y_Neg[1];
	renderLight->shaderParms[ 18 ]	= ambColor_Y_Neg[2];
	renderLight->shaderParms[ 19 ]	= ambColor_Y_Pos[0];
	renderLight->shaderParms[ 20 ]	= ambColor_Y_Pos[1];
	renderLight->shaderParms[ 21 ]	= ambColor_Y_Pos[2];
	renderLight->shaderParms[ 22 ]	= ambColor_Z_Neg[0];
	renderLight->shaderParms[ 23 ]	= ambColor_Z_Neg[1];
	renderLight->shaderParms[ 24 ]	= ambColor_Z_Neg[2];
	renderLight->shaderParms[ 25 ]	= ambColor_Z_Pos[0];
	renderLight->shaderParms[ 26 ]	= ambColor_Z_Pos[1];
	renderLight->shaderParms[ 27 ]	= ambColor_Z_Pos[2];
// <--- sikk - Ambient Light Color
