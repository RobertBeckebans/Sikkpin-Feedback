...
int idPlayer::GetLevelStat( int stat )
{
	...
	switch( stat )
	{
		...
		case KILLS:
			...
			break;
		case ENEMYCOUNT:
			i = levelStats.enemyCount;
			break;
		case SECRETSFOUND:
			i = levelStats.secretsFound;
			break;
		case SECRETSTOTAL:
			i = levelStats.secretsTotal;
			break;
		case ENERGY:
			i = levelStats.energy;
			break;
		case COMBOS:
			...
			break;
		case SHOTSFIRED:
			i = levelStats.shotsFired;
			break;
		case SHOTSHIT:
			i = levelStats.shotsHit;
			break;
		case DAMAGEDEALT:
			i = levelStats.damageDealt;
			break;
		case DAMAGETAKEN:
			i = levelStats.damageTaken;
			break;
	}
...
void idPlayer::SetLevelStat( int stat, int amount )
{
	...
	{
		case TIME:
			levelStats.time			= amount;
			break;
		case SCORE:
			levelStats.score		= amount;
			break;
		case SCORETOTAL:
			levelStats.scoreTotal	= amount;
			break;
		case LIVES:
			levelStats.lives		= amount;
			break;
		case KILLS:
			levelStats.kills		= amount;
			break;
		case ENEMYCOUNT:
			levelStats.enemyCount	= amount;
			break;
		case SECRETSFOUND:
			levelStats.secretsFound	= amount;
			break;
		case SECRETSTOTAL:
			levelStats.secretsTotal	= amount;
			break;
		case ENERGY:
			levelStats.energy		= amount;
			break;
		case COMBOS:
			levelStats.combos		= amount;
			break;
		case SHOTSFIRED:
			levelStats.shotsFired	= amount;
			break;
		case SHOTSHIT:
			levelStats.shotsHit		= amount;
			break;
		case DAMAGEDEALT:
			levelStats.damageDealt	= amount;
			break;
		case DAMAGETAKEN:
			levelStats.damageTaken	= amount;
			break;
	}
}
...
void idPlayer::UpdateModifiers()
{
	...
	{
		case MOD_PLAYER_SPEED:
			modifiers.player_speed				= 1.5f;
			break;
		case MOD_PLAYER_DOUBLEJUMP:
			modifiers.player_doublejump			= true;
			break;
		case MOD_PLAYER_AIRCONTROL:
			modifiers.player_aircontrol			= 10.0f;
			break;

		case MOD_WEAPON_PROJECTILESPEED:
			modifiers.weapon_projectilespeed	= 2;
			break;
		case MOD_WEAPON_PROJECTILEDOUBLER:
			modifiers.weapon_projectiledoubler	= 2;
			break;
		case MOD_WEAPON_INCENDIARY:
			modifiers.weapon_incendiary			= true;
			break;

		case MOD_ENERGY_RECHARGERATE:
			modifiers.energy_rechargerate		= 0.5f;
			break;
		case MOD_ENERGY_CONSERVATION:
			modifiers.energy_conservation		= 2.0f;
			break;
		case MOD_ENERGY_PICKUPDOUBLER:
			modifiers.energy_pickupdoubler		= 2;
			break;

		case MOD_MISC_SCOREDOUBLER:
			modifiers.misc_scoredoubler			= 2;
			break;
		case MOD_MISC_POWERUPTIMEDOUBLER:
			modifiers.misc_poweruptimedoubler	= 2;
			break;
		case MOD_MISC_COMBOTIMEDOUBLER:
			modifiers.misc_combotimedoubler		= 2;
			break;
	}
}
// <--- sikk - Modifier System
