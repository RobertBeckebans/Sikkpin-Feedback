...
#define SUBSAMPLE_WALK_PATH		1	//1 // sikk - improves performance with hordes
#define SUBSAMPLE_FLY_PATH		0

const int		maxWalkPathIterations		= 10;	//10; // sikk - improves performance with hordes
const float		maxWalkPathDistance			= 500.0f;	//500.0f; // sikk - improves performance with hordes
const float		walkPathSampleDistance		= 8.0f;

const int		maxFlyPathIterations		= 10;	//10; // sikk - improves performance with hordes
const float		maxFlyPathDistance			= 500.0f;	//500.0f; // sikk - improves performance with hordes
